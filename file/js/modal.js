$(document).ready(function(){
  ...
  var modalText = {
    rpa: {
      title: 'RPA 업무자동화',
      tag: '2019.09 / 로봇 프로세스 자동화 / SoftBank',
    ...
    hikkoshi: {
      title: '이사비용 결제시스템',
      tag: '2019.07 ~ 2019.08 / 移徙(이사)비용 처리 / 소득세 개정',
      detail: '사내직원들의 이사에 따른 비용을 청구하고 집행 및 결제하는 시스템입니다. 일본 소득세 개정안에 따른 청구비용 변화를 적용, 이사 목적에 따른 프로세스 로직 수정, 부서별 코드를 검색기능을 추가하고, 버그 수정 및 인터페이스를 개선했습니다.',
      link: ''
    },
    bander: {
      title: '반다: 데이터 관리시스템',
      tag: '2019.05 ~ 2019.07 / 타이어 스캔 이미지 / 자동관리 / Sick AG',
    ...
    scm: {
      title: 'SCM 혁명',
      tag: '2018.05 ~ 2019.01 / 공급망 관리 / 빅 데이터 / 스마트팩토리 / JDA',
